...
Use the script to clone all the CKAN source repos onto your host
machine:
...
At data.gov.uk we transfer database by first creating a dump (using
...
You can now log-in by executing 'drush uli' in Drupal root folder. This
